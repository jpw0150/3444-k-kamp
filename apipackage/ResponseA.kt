...
data class Ingredient(val id: Int, val food: String, val amount: Int)
...
data class ResponseIngredients(@SerializedName("error") val error: Boolean, val message: String, val ingredient: Ingredient)
data class ResponseIngredient(@SerializedName("error") val error: Boolean, val message: String, val Ingredients: List<Ingredient>)